...
namespace VehicleMonitoringSystem.Client.Pages
{
    public partial class ApplicationRoles
    {
        ...
        protected IEnumerable<VehicleMonitoringSystem.Server.Models.ApplicationRole> roles;
        protected RadzenDataGrid<VehicleMonitoringSystem.Server.Models.ApplicationRole> grid0;
        ...
        protected async Task DeleteClick(VehicleMonitoringSystem.Server.Models.ApplicationRole role)
        {
            try
            {
