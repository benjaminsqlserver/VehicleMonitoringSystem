...
namespace VehicleMonitoringSystem.Client.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<VehicleMonitoringSystem.Server.Models.ApplicationUser> users;
        protected RadzenDataGrid<VehicleMonitoringSystem.Server.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(VehicleMonitoringSystem.Server.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(VehicleMonitoringSystem.Server.Models.ApplicationUser user)
        {
            try
            {
