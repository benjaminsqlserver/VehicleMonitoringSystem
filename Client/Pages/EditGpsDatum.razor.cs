...
{
    public partial class EditGpsDatum
    {
        [Inject]
        ...
        {
            gpsDatum = await ConDataService.GetGpsDatumByGpsdataId(gpsdataId:GPSDataID);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await ConDataService.UpdateGpsDatum(gpsdataId:GPSDataID, gpsDatum);
